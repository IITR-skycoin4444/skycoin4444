...
const COURSES = [
  ...
  { id: 13, slug: "english-fluency", category: "languages", title: "English Fluency Mastery", subtitle: "Business & conversational English from A1 to C2", instructor: "Prof. James Mitchell", instructorAvatar: "JM", level: "Beginner", duration: "40h 00m", lessons: 160, students: 89234, rating: 4.9, reviews: 12456, price: 0, tags: ["Speaking", "Grammar", "TOEFL", "Business"], thumbnail: "🇺🇸", color: "from-blue-500/20 to-cyan-500/20", border: "border-blue-500/30", badge: "Most Popular", badgeColor: "bg-blue-500/20 text-blue-400", description: "Master English from beginner to advanced. Covers pronunciation, grammar, business communication, TOEFL prep, and real-world conversation skills." },
  { id: 14, slug: "mandarin-chinese", category: "languages", title: "Mandarin Chinese Mastery", subtitle: "Learn Mandarin from basics to fluency with HSK certification", instructor: "Dr. Li Wei", instructorAvatar: "LW", level: "Beginner", duration: "50h 00m", lessons: 200, students: 67890, rating: 4.8, reviews: 9876, price: 0, tags: ["Mandarin", "HSK", "Characters", "Tones"], thumbnail: "🇨🇳", color: "from-red-500/20 to-pink-500/20", border: "border-red-500/30", badge: "Trending", badgeColor: "bg-red-500/20 text-red-400", description: "Complete Mandarin Chinese course from HSK 1 to HSK 6. Master tones, characters, grammar, and conversational skills with interactive practice." },
  { id: 15, slug: "spanish-essentials", category: "languages", title: "Spanish Essentials", subtitle: "Spanish for travel, business, and daily life", instructor: "María García", instructorAvatar: "MG", level: "Beginner", duration: "35h 00m", lessons: 140, students: 54321, rating: 4.7, reviews: 7654, price: 0, tags: ["Spanish", "DELE", "Conversational", "Travel"], thumbnail: "🇪🇸", color: "from-yellow-500/20 to-orange-500/20", border: "border-yellow-500/30", badge: "Popular", badgeColor: "bg-yellow-500/20 text-yellow-400", description: "Learn Spanish for real-world situations. Covers essential grammar, travel phrases, business Spanish, and DELE exam preparation." },
  { id: 16, slug: "french-culture", category: "languages", title: "French Language & Culture", subtitle: "Master French while exploring European culture", instructor: "Pierre Dubois", instructorAvatar: "PD", level: "Beginner", duration: "38h 00m", lessons: 152, students: 43210, rating: 4.8, reviews: 6543, price: 0, tags: ["French", "DELF", "Culture", "Conversation"], thumbnail: "🇫🇷", color: "from-purple-500/20 to-violet-500/20", border: "border-purple-500/30", badge: "New", badgeColor: "bg-purple-500/20 text-purple-400", description: "Learn French with cultural context. Includes grammar, pronunciation, business French, DELF preparation, and French cinema insights." },
  { id: 17, slug: "german-professional", category: "languages", title: "German for Professionals", subtitle: "Business German & technical vocabulary", instructor: "Klaus Schmidt", instructorAvatar: "KS", level: "Intermediate", duration: "42h 00m", lessons: 168, students: 32145, rating: 4.7, reviews: 5432, price: 0, tags: ["German", "Business", "Technical", "Goethe"], thumbnail: "🇩🇪", color: "from-gray-500/20 to-slate-500/20", border: "border-gray-500/30", badge: "Expert", badgeColor: "bg-gray-500/20 text-gray-400", description: "Master professional German. Covers business communication, technical vocabulary, Goethe certification prep, and German business culture." },
  { id: 18, slug: "japanese-beginner", category: "languages", title: "Japanese Language Fundamentals", subtitle: "Hiragana, Katakana, Kanji & conversational Japanese", instructor: "Yuki Tanaka", instructorAvatar: "YT", level: "Beginner", duration: "45h 00m", lessons: 180, students: 56789, rating: 4.9, reviews: 8765, price: 0, tags: ["Japanese", "JLPT", "Kanji", "Culture"], thumbnail: "🇯🇵", color: "from-red-500/20 to-white/20", border: "border-red-500/30", badge: "Bestseller", badgeColor: "bg-red-500/20 text-red-400", description: "Complete Japanese fundamentals. Master hiragana, katakana, kanji, grammar, and conversational skills with JLPT N5-N3 prep." },
];
