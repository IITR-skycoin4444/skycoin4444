...
export default function Analytics30() {
  const { user } = useAuth();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-purple-900 to-black">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Analytics30</h1>
          <p className="text-gray-400 mb-8">Analytics screen 30</p>
          <Link href="/signup">
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-black">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Analytics screen 30</p>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card className="bg-black/40 border-purple-500/20 p-8">
              <div className="text-center py-12">
                <h2 className="text-2xl font-bold text-white mb-4">Analytics30</h2>
                <p className="text-gray-400 mb-6">Analytics screen 30</p>
              ...
              <Tabs defaultValue="overview" className="mt-6">
                ...
                <TabsContent value="overview" className="mt-4">
                  <div className="space-y-4">
                    <p className="text-gray-400">Overview content for Analytics30</p>
                  </div>
                </TabsContent>
                <TabsContent value="details" className="mt-4">
                  <div className="space-y-4">
                    <p className="text-gray-400">Details content for Analytics30</p>
                  </div>
                </TabsContent>
                <TabsContent value="settings" className="mt-4">
                  <div className="space-y-4">
                    <p className="text-gray-400">Settings content for Analytics30</p>
                  </div>
                </TabsContent>
              </Tabs>
            </Card>
