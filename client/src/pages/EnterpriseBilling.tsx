...
export default function EnterpriseBilling() {
  ...
  const mockInvoices = [
    { id: "INV-001", date: "2026-07-01", amount: 10000, status: "paid", service: "Enterprise Package" },
    { id: "INV-002", date: "2026-06-01", amount: 10000, status: "paid", service: "Enterprise Package" },
    { id: "INV-003", date: "2026-05-01", amount: 10000, status: "paid", service: "Enterprise Package" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Enterprise Billing</h1>
